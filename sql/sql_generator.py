...
- 以下为每日管控计划，每日管控计划_子表与安全责任单元履职清单主表的 字段与扩展说明（帮助你理解表结构）：
    ...
    -每日管控计划_子表.领导带班 是指1就是有，空就是无。每日管控计划_子表.带班领导档案就是带班人员领导的领导档案
    -每日管控计划_子表.领导跟班 是指1就是有，空就是无。每日管控计划_子表.跟班领导档案就是跟班人员领导的领导档案
    -带班作业记录表.工单ID 与 每日管控计划.ID 对应，意思就是带班作业记录表ID125 工单ID10 就说明 这个根本记录是每日管控计划ID10中的计划的带班记录
    -带班作业记录表.工单子表ID 与 每日管控计划_子表.ID 对应，意思带班作业记录表ID125 工单子表ID10 就说明 这个根本记录是每日管控计划子表ID10中的计划的带班记录
    -跟班作业记录表.工单ID 与 每日管控计划.ID 对应，意思就是跟班作业记录表ID125 工单ID10 就说明 这个根本记录是每日管控计划ID10中的计划的跟班记录
    -跟班作业记录表.工单子表ID 与 每日管控计划_子表.ID 对应，意思跟班作业记录表ID125 工单子表ID10 就说明 这个根本记录是每日管控计划子表ID10中的计划的跟班记录
